...
const translations = {
  en: {
    ...
    'p3-desc': 'Custom chatbot for business use. Context-aware, trainable on company data, and embeddable in any website.',
    'p3-status': 'Done',
  ...
  my: {
    ...
    'p2-status': 'Selesai',
    'p3-tag': 'Chatbot', 'p3-title': 'Chatbot WS',
    'p3-desc': 'Chatbot tersuai untuk kegunaan perniagaan. Sedar konteks, boleh dilatih pada data syarikat, dan boleh dibenamkan dalam mana-mana laman web.',
    'p3-status': 'Selesai',
