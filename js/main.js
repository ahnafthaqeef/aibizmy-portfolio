...
const translations = {
  en: {
    ...
    'hero-sub': "I'm Ahnaf Thaqeef. I design and build AI systems, RAG pipelines, and automation workflows that cut costs and generate real business results.",
    'hero-btn-1': 'See My Work', 'hero-btn-2': 'Get In Touch',
    'stat-1': 'AI Projects', 'stat-2': 'Live Apps', 'stat-3': 'Business-Focused',
    'scroll': 'Scroll',
    'about-label': 'About',
    ...
    'about-p2': "From n8n automation pipelines to RAG systems with vector search, to full-stack AI SaaS products. I build end-to-end AI that delivers measurable results. MYR 500k+ in documented business impact across supply chain, manufacturing, and SaaS.",
    'about-p3': "I work where product thinking meets technical execution. If there's a problem worth solving, I'll find the right AI approach for it.",
    ...
    'cat-ai-desc': 'Agents, chatbots, voice, and workflow automation',
    'cat-saas-desc': 'Full-stack products live and running',
    ...
    'p2-status': 'Done',
    'p3-tag': 'Chatbot', 'p3-title': 'Business Chatbot — RAG',
    'p3-desc': 'AI chatbot built on Claude and a full RAG pipeline. Ingests real company data and answers customer questions accurately. Embeds as a widget on any website. Demo: live automotive spec assistant trained on Proton X50 data.',
    'p3-status': 'Done',
    ...
    'p7-desc': 'Upload your CV, paste a job description, and get a tailored ATS-ready resume in seconds. Built with AI-powered rewriting and Supabase auth.',
    'p7-status': 'Live',
    ...
    'p9-desc': 'Event management platform with attendee registration, agenda builder, and check-in workflow for end-to-end event ops.',
    'p9-status': 'Live',
    ...
    'p10-status': 'Live',
    'p11-tag': 'CX AI', 'p11-title': 'CX Intelligence Suite',
    'p11-desc': '4-in-1 customer experience AI platform: an agentic telco service bot, contact center analytics dashboard, GenAI ROI value case builder, and service blueprint generator. Built for SEA enterprise CX teams.',
    'p11-status': 'Live',
    'filter-ml': 'ML Engineering',
    'cat-ml-desc': 'Distributed training, transformer architecture, evaluation frameworks, and cloud ML deployment',
    'p15-tag': 'Distributed ML', 'p15-title': 'Distributed Training — PyTorch DDP + Accelerate',
    'p15-desc': 'Multi-process fine-tuning of DistilBERT transformer architecture using PyTorch DDP and HuggingFace Accelerate. Same script scales from 1 CPU to N-GPU clusters without code changes. Includes DistributedSampler, all_reduce distributed evaluation, and failure mode analysis. Model published to HuggingFace Hub.',
    'p15-status': 'Done',
    'p12-tag': 'ML Engineering', 'p12-title': 'Transformer Fine-Tuning Lab — DistilBERT + LoRA',
    'p12-desc': 'End-to-end training pipeline for DistilBERT (6 layers, 66M params). LoRA fine-tuning: 592K trainable / 67.6M total (0.88%). 82.45% accuracy, F1 0.8246 on SST-2 validation. Integrated as sentiment pre-screening layer in insurance claims triage pipeline. Deployed to SageMaker and Vertex AI.',
    'p12-status': 'Done',
    'p13-tag': 'ML Evaluation', 'p13-title': 'Research-Grade LLM Evaluation Framework',
    'p13-desc': 'Novel dual-layer evaluation framework for LLM alignment — 2,000+ real inferences evaluated. Ragas automated scoring + LangSmith human-preference labelling on 312 high-confidence failures. 5-category failure taxonomy (negation blindness 27.9%, sarcasm 19.6%, code-switching 17.3%).',
    'p13-status': 'Done',
    'p14-tag': 'Cloud ML', 'p14-title': 'Large-Scale ML Training & Inference Infrastructure',
    'p14-desc': 'End-to-end ML training and inference infrastructure across AWS SageMaker and GCP Vertex AI. Model packaging, distributed training job config, real-time inference endpoints, and cost-optimised teardown automation. Multi-cloud A/B benchmarking on latency and cost.',
    'p14-status': 'Done',
  ...
  my: {
    ...
    'hero-sub': 'Saya Ahnaf Thaqeef. Saya mereka dan membina sistem AI, saluran paip RAG, dan aliran kerja automasi yang mengurangkan kos dan menghasilkan keputusan perniagaan nyata.',
    'hero-btn-1': 'Lihat Kerja Saya', 'hero-btn-2': 'Hubungi Saya',
    'stat-1': 'Projek AI', 'stat-2': 'Aplikasi Langsung', 'stat-3': 'Fokus Perniagaan',
    'scroll': 'Tatal',
    'about-label': 'Tentang',
    ...
    'about-p2': 'Dari saluran paip automasi n8n hingga sistem RAG dengan carian vektor, hingga produk SaaS AI penuh. Saya membina AI hujung-ke-hujung yang memberikan hasil terukur. Lebih MYR 500k impak perniagaan yang didokumenkan merentasi rantaian bekalan, pembuatan, dan SaaS.',
    ...
    'cat-ai-desc': 'Ejen, chatbot, suara, dan automasi aliran kerja',
    'cat-saas-desc': 'Produk penuh yang sudah dilancarkan',
    ...
    'p2-status': 'Selesai',
    'p3-tag': 'Chatbot', 'p3-title': 'Chatbot Perniagaan — RAG',
    'p3-desc': 'Chatbot AI dibina atas Claude dan saluran RAG penuh. Menelan data syarikat sebenar dan menjawab soalan pelanggan dengan tepat. Boleh dibenamkan sebagai widget di mana-mana laman web. Demo: penolong spesifikasi automotif langsung dilatih pada data Proton X50.',
    'p3-status': 'Selesai',
    ...
    'p7-desc': 'Muat naik CV anda, tampal keterangan kerja, dan dapatkan resume yang disesuaikan serta mesra ATS dalam beberapa saat.',
    'p7-status': 'Langsung',
    ...
    'p9-desc': 'Platform pengurusan acara dengan pendaftaran peserta, pembina agenda, dan aliran kerja daftar masuk untuk ops acara hujung-ke-hujung.',
    'p9-status': 'Langsung',
    ...
    'p10-status': 'Langsung',
    'p11-tag': 'CX AI', 'p11-title': 'CX Intelligence Suite',
    'p11-desc': 'Platform AI pengalaman pelanggan 4-dalam-1: bot perkhidmatan telco beragenik, papan pemuka analitik pusat hubungi, pembina kes nilai ROI GenAI, dan penjana pelan perkhidmatan. Dibina untuk pasukan CX enterprise Asia Tenggara.',
    'p11-status': 'Langsung',
    'filter-ml': 'Kejuruteraan ML',
    'cat-ml-desc': 'Latihan teragih, seni bina transformer, rangka kerja penilaian, dan penggunaan ML awan',
    'p15-tag': 'ML Teragih', 'p15-title': 'Latihan Teragih — PyTorch DDP + Accelerate',
    'p15-desc': 'Penalaan halus berbilang proses bagi seni bina transformer DistilBERT menggunakan PyTorch DDP dan HuggingFace Accelerate. Skrip yang sama berskala dari 1 CPU hingga kelompok N-GPU. Model diterbitkan ke HuggingFace Hub dengan kad model lengkap.',
    'p15-status': 'Selesai',
    'p12-tag': 'Kejuruteraan ML', 'p12-title': 'Makmal Penalaan Transformer — DistilBERT + LoRA',
    'p12-desc': 'Saluran latihan hujung-ke-hujung untuk DistilBERT (6 lapisan, 66M param). Penalaan halus LoRA: 592K boleh latih / 67.6M jumlah (0.88%). Ketepatan 82.45%, F1 0.8246 pada pengesahan SST-2. Diintegrasikan sebagai lapisan pra-saringan sentimen dalam saluran triage tuntutan.',
    'p12-status': 'Selesai',
    'p13-tag': 'Penilaian ML', 'p13-title': 'Rangka Kerja Penilaian LLM Gred Penyelidikan',
    'p13-desc': 'Rangka kerja penilaian dwi-lapisan novel untuk penjajaran LLM — 2,000+ inferens sebenar dinilai. Pemarkahan automatik Ragas + pelabelan pilihan manusia LangSmith pada 312 kegagalan berkeyakinan tinggi. Taksonomi kegagalan 5 kategori.',
    'p13-status': 'Selesai',
    'p14-tag': 'ML Awan', 'p14-title': 'Penggunaan ML Awan — SageMaker + Vertex AI',
    'p14-desc': 'Saluran penggunaan ML hujung-ke-hujung: pembungkusan model (tar.gz), pementasan S3, titik akhir AWS SageMaker HuggingFaceModel, dan bekas tersuai GCP Vertex AI melalui Docker + Google Artifact Registry. Automasi pembongkaran terkawal kos.',
    'p14-status': 'Selesai',
  ...
  zh: {
    ...
    'hero-sub': '我是 Ahnaf Thaqeef。我设计并构建 AI 系统、RAG 管道和自动化工作流，降低成本并产生真实的业务成果。',
    'hero-btn-1': '查看我的作品', 'hero-btn-2': '联系我',
    'stat-1': 'AI 项目', 'stat-2': '上线应用', 'stat-3': '专注商业',
    'scroll': '滚动',
    'about-label': '关于',
    'about-title': '我将想法转化为<br/><span class="gradient-text">可运行的 AI 系统</span>',
    'about-p1': '我专注于一个问题：<strong>AI 如何让企业真正变得更好？</strong>',
    'about-p2': '从 n8n 自动化管道到具有向量检索的 RAG 系统，再到全栈 AI SaaS 产品——我构建端到端的 AI，带来可衡量的成果。在供应链、制造业和 SaaS 领域已记录超过 MYR 50 万的业务影响。',
    ...
    'cat-ai-desc': '智能体、聊天机器人、语音与工作流自动化',
    'cat-saas-desc': '已上线运行的全栈产品',
    ...
    'p10-status': '已上线',
    'p11-tag': 'CX AI', 'p11-title': 'CX 智能套件',
    'p11-desc': '4合1客户体验AI平台——智能型Telco服务机器人、客服中心分析仪表板、GenAI ROI价值案例构建器，以及服务蓝图生成器。专为东南亚企业CX团队打造。',
    'p11-status': '已上线',
    'filter-ml': 'ML 工程',
    'cat-ml-desc': '分布式训练、Transformer 架构、评估框架与云端 ML 部署',
    'p15-tag': '分布式 ML', 'p15-title': '分布式训练 — PyTorch DDP + Accelerate',
    'p15-desc': '使用 PyTorch DDP 和 HuggingFace Accelerate 对 DistilBERT Transformer 架构进行多进程微调。同一脚本从单 CPU 无缝扩展至 N-GPU 集群。模型已发布至 HuggingFace Hub，附完整模型卡片及故障模式分析。',
    'p15-status': '已完成',
    'p12-tag': 'ML 工程', 'p12-title': 'Transformer 微调实验室 — DistilBERT + LoRA',
    'p12-desc': '针对 DistilBERT（6 层，66M 参数）的端到端训练流水线。LoRA 微调：592K 可训练 / 67.6M 总参数（0.88%）。SST-2 验证集准确率 82.45%，F1 值 0.8246。集成为保险理赔分诊流水线的情感预筛选层。',
    'p12-status': '已完成',
    'p13-tag': 'ML 评估', 'p13-title': '研究级 LLM 评估框架',
    'p13-desc': '针对 LLM 对齐性的新型双层评估框架，评估 2,000+ 条真实推理输出。Ragas 自动评分 + LangSmith 对 312 条高置信度错误的人工偏好标注。5 类故障分类法（否定盲点 27.9%、讽刺 19.6%、代码切换 17.3%）。',
    'p13-status': '已完成',
    'p14-tag': '云端 ML', 'p14-title': '大规模 ML 训练与推理基础设施',
    'p14-desc': '跨 AWS SageMaker 和 GCP Vertex AI 的端到端 ML 训练与推理基础设施。涵盖模型打包、分布式训练任务配置、实时推理端点及成本优化的自动清理。多云 A/B 延迟与成本基准测试。',
    'p14-status': '已完成',
    'launch-app': '打开应用 →',
    'blog-label': '内容',
