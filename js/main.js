...
const translations = {
  en: {
    ...
    'cat-ml-desc': 'Model fine-tuning, evaluation frameworks, and cloud ML deployment',
    'p12-tag': 'ML Engineering', 'p12-title': 'DistilBERT Fine-Tune Lab',
    'p12-desc': 'Fine-tuned distilbert-base-uncased on SST-2 using PyTorch + HuggingFace Trainer API with LoRA (PEFT) — 82%+ validation accuracy. Integrated as a sentiment pre-screening layer in the insurance claims triage pipeline. Deployed to AWS SageMaker and GCP Vertex AI.',
    'p12-status': 'Done',
    'p13-tag': 'ML Evaluation', 'p13-title': 'Dual-Layer Eval Framework',
    'p13-desc': 'Production evaluation framework: Ragas RAG quality scoring (faithfulness, answer relevancy, context precision) on a FAISS RAG pipeline + LangGraph claims-triage eval harness with 20-record golden dataset, routing accuracy gate, CRITICAL recall metric, and LangSmith experiment tracking.',
    'p13-status': 'Done',
    'p14-tag': 'Cloud ML', 'p14-title': 'Cloud ML Deployment — SageMaker + Vertex AI',
    'p14-desc': 'End-to-end ML deployment pipeline for a fine-tuned HuggingFace model: model packaging (tar.gz), S3 staging, AWS SageMaker HuggingFaceModel endpoint (ml.t2.medium), and GCP Vertex AI custom container via Docker + Google Artifact Registry. Cost-controlled teardown automation.',
    'p14-status': 'Done',
  ...
  my: {
    ...
    'cat-ml-desc': 'Penalaan model, rangka kerja penilaian, dan penggunaan ML awan',
    'p12-tag': 'Kejuruteraan ML', 'p12-title': 'Makmal Penalaan DistilBERT',
    'p12-desc': 'Menala halus distilbert-base-uncased pada SST-2 menggunakan PyTorch + HuggingFace Trainer API dengan LoRA (PEFT) — ketepatan pengesahan 82%+. Diintegrasikan sebagai lapisan pra-saringan sentimen dalam saluran triage tuntutan insurans. Digunakan ke AWS SageMaker dan GCP Vertex AI.',
    'p12-status': 'Selesai',
    'p13-tag': 'Penilaian ML', 'p13-title': 'Rangka Kerja Penilaian Dwi-Lapisan',
    'p13-desc': 'Rangka kerja penilaian pengeluaran: pemarkahan kualiti RAG Ragas (kesetiaan, relevan jawapan, ketepatan konteks) + harness penilaian triage tuntutan LangGraph dengan 20 rekod set data emas, gerbang ketepatan laluan, metrik recall KRITIKAL, dan penjejakan eksperimen LangSmith.',
    'p13-status': 'Selesai',
  ...
  zh: {
    ...
    'p11-status': '已上线',
    'filter-ml': 'ML 工程',
    'cat-ml-desc': '模型微调、评估框架与云端 ML 部署',
    'p12-tag': 'ML 工程', 'p12-title': 'DistilBERT 微调实验室',
    'p12-desc': '使用 PyTorch + HuggingFace Trainer API 与 LoRA (PEFT) 在 SST-2 上微调 distilbert-base-uncased，验证准确率 82%+。作为保险理赔分诊流水线的情感预筛选层集成。部署至 AWS SageMaker 和 GCP Vertex AI。',
    'p12-status': '已完成',
    'p13-tag': 'ML 评估', 'p13-title': '双层评估框架',
    'p13-desc': '生产级评估框架：Ragas RAG 质量评分（忠实度、答案相关性、上下文精确度）+ LangGraph 理赔分诊评估套件，含 20 条黄金数据集、路由准确率门控、CRITICAL 召回指标及 LangSmith 实验追踪。',
    'p13-status': '已完成',
    'p14-tag': '云端 ML', 'p14-title': '云端 ML 部署 — SageMaker + Vertex AI',
    'p14-desc': '端到端 ML 部署流水线：模型打包（tar.gz）、S3 暂存、AWS SageMaker HuggingFaceModel 端点，以及通过 Docker + Google Artifact Registry 的 GCP Vertex AI 自定义容器。具备成本控制的自动清理。',
    'p14-status': '已完成',
    'launch-app': '打开应用 →',
    'blog-label': '内容',
