...
const translations = {
  en: {
    ...
    'hero-sub': "I'm Ahnaf Thaqeef — I design and build AI systems, RAG pipelines, and automation workflows that cut costs and generate real business outcomes.",
    ...
    'p11-desc': '4-in-1 customer experience AI platform — agentic telco service bot, contact center analytics dashboard, GenAI ROI value case builder, and service blueprint generator. Built for SEA enterprise CX teams.',
    'p11-status': 'Live',
